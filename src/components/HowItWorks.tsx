            ...
            <div key={index} className="relative">
              <Card className="border-border hover:shadow-fintech transition-all duration-300 group">
                <CardContent className="p-8 text-center">
                  ...
                  {/* Icon */}
                  <div className="w-16 h-16 bg-fintech-light-teal rounded-lg flex items-center justify-center mx-auto mb-6">
                    <step.icon className="h-8 w-8 text-fintech-teal" />
                  </div>

                  {/* Content */}
                  <h3 className="text-xl font-bold text-fintech-navy mb-4">
                    {step.title}
                  </h3>
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-1/2 -right-6 lg:-right-12 transform -translate-y-1/2 z-10">
                  ...
                  <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-0 h-0 border-l-4 border-l-fintech-teal border-t-2 border-b-2 border-t-transparent border-b-transparent"></div>
                </div>
              )}
            </div>
          ))}
